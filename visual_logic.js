...
registerOnClick('IMAGEN3', false, false, [0,1,2], false, function(event) {
    zoomCamera('IMAGEN3', 1, function() {});
}, function(event) {});
registerOnClick('IMAGEN4', false, false, [0,1,2], false, function(event) {
    zoomCamera('IMAGEN4', 1, function() {});
    registerOnClick('IMAGEN5', false, false, [0,1,2], false, function(event) {
        zoomCamera('IMAGEN5', 1, function() {});
    }, function(event) {});
}, function(event) {});
